...
;; @@
;; =>
;;; {"type":"vega","content":{"scales":[{"name":"x","range":"width","domain":[0,5]},{"name":"y","range":"height","domain":[-1,3],"reverse":true}],"axes":[{"type":"x","scale":"x","ticks":"nice","values":[0,1,2,3,4],"grid":true,"orient":"top","properties":{"labels":{"x":{"scale":"x","offset":15}}}},{"type":"y","scale":"y","ticks":"nice","values":[-1,0,1,2],"grid":true,"properties":{"labels":{"y":{"scale":"y","offset":15}}}},{"scale":"y","type":"y","orient":"right","ticks":0},{"scale":"x","type":"x","orient":"bottom","ticks":0},{"scale":"x","type":"x","orient":"top","ticks":0}],"marks":[{"type":"rect","from":{"data":"fcf8d6a6-72ae-46ab-96fc-e96e43641264"},"properties":{"enter":{"x":{"scale":"x","field":"data.x"},"x2":{"scale":"x","field":"data.x2"},"y":{"scale":"y","field":"data.y"},"y2":{"scale":"y","field":"data.y2"},"fill":{"value":"red"},"fillOpacity":{"field":"data.opacity"}}}},{"type":"text","from":{"data":"fcf8d6a6-72ae-46ab-96fc-e96e43641264"},"properties":{"enter":{"y":{"scale":"y","field":"data.y"},"baseline":{"value":"middle"},"align":{"value":"center"},"fill":{"value":"black"},"width":{"value":29},"dy":{"value":15},"x":{"scale":"x","field":"data.x","offset":15},"fontSize":{"value":18.0},"text":{"field":"data.text"}}}}],"data":[{"name":"fcf8d6a6-72ae-46ab-96fc-e96e43641264","values":[{"x":1,"x2":2,"y":1,"y2":2,"text":null,"opacity":1},{"x":2,"x2":3,"y":0,"y2":1,"text":null,"opacity":1},{"x":3,"x2":4,"y":1,"y2":2,"text":null,"opacity":1}]}],"width":150,"height":120},"value":"#gorilla_repl.vega.VegaView{:content {:scales [{:name \"x\", :range \"width\", :domain [0 5]} {:name \"y\", :range \"height\", :domain [-1 3], :reverse true}], :axes [{:type \"x\", :scale \"x\", :ticks \"nice\", :values (0 1 2 3 4), :grid true, :orient \"top\", :properties {:labels {:x {:scale \"x\", :offset 15}}}} {:type \"y\", :scale \"y\", :ticks \"nice\", :values (-1 0 1 2), :grid true, :properties {:labels {:y {:scale \"y\", :offset 15}}}} {:scale \"y\", :type \"y\", :orient \"right\", :ticks 0} {:scale \"x\", :type \"x\", :orient \"bottom\", :ticks 0} {:scale \"x\", :type \"x\", :orient \"top\", :ticks 0}], :marks [{:type \"rect\", :from {:data \"fcf8d6a6-72ae-46ab-96fc-e96e43641264\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :x2 {:scale \"x\", :field \"data.x2\"}, :y {:scale \"y\", :field \"data.y\"}, :y2 {:scale \"y\", :field \"data.y2\"}, :fill {:value \"red\"}, :fillOpacity {:field \"data.opacity\"}}}} {:type \"text\", :from {:data \"fcf8d6a6-72ae-46ab-96fc-e96e43641264\"}, :properties {:enter {:y {:scale \"y\", :field \"data.y\"}, :baseline {:value \"middle\"}, :align {:value \"center\"}, :fill {:value \"black\"}, :width {:value 29}, :dy {:value 15}, :x {:scale \"x\", :field \"data.x\", :offset 15}, :fontSize {:value 18.0}, :text {:field \"data.text\"}}}}], :data [{:name \"fcf8d6a6-72ae-46ab-96fc-e96e43641264\", :values ({:x 1, :x2 2, :y 1, :y2 2, :text nil, :opacity 1} {:x 2, :x2 3, :y 0, :y2 1, :text nil, :opacity 1} {:x 3, :x2 4, :y 1, :y2 2, :text nil, :opacity 1})}], :width 150, :height 120}}"}
;; <=
...
;; @@
;; =>
;;; {"type":"vega","content":{"width":150,"height":120,"padding":null,"scales":[{"name":"x","range":"width","domain":[0,5]},{"name":"y","range":"height","domain":[-1,3],"reverse":true}],"axes":[{"type":"x","scale":"x","ticks":"nice","values":[0,1,2,3,4],"grid":true,"orient":"top","properties":{"labels":{"x":{"scale":"x","offset":15}}}},{"type":"y","scale":"y","ticks":"nice","values":[-1,0,1,2],"grid":true,"properties":{"labels":{"y":{"scale":"y","offset":15}}}},{"scale":"y","type":"y","orient":"right","ticks":0},{"scale":"x","type":"x","orient":"bottom","ticks":0},{"scale":"x","type":"x","orient":"top","ticks":0}],"data":[{"name":"898f21dd-a942-4854-98ba-a6176be537ae","values":[{"x":1,"x2":2,"y":1,"y2":2,"text":null,"opacity":1},{"x":2,"x2":3,"y":0,"y2":1,"text":null,"opacity":1},{"x":3,"x2":4,"y":1,"y2":2,"text":null,"opacity":1}]},{"name":"4b5dc34a-cf5f-491c-bd9b-3583af09856c","values":[{"x":2,"x2":3,"y":2,"y2":3,"text":2,"opacity":0.4},{"x":0,"x2":1,"y":0,"y2":1,"text":1,"opacity":0.2},{"x":2,"x2":3,"y":-1,"y2":0,"text":1,"opacity":0.2},{"x":1,"x2":2,"y":0,"y2":1,"text":2,"opacity":0.4},{"x":1,"x2":2,"y":1,"y2":2,"text":1,"opacity":0.2},{"x":4,"x2":5,"y":2,"y2":3,"text":1,"opacity":0.2},{"x":3,"x2":4,"y":0,"y2":1,"text":2,"opacity":0.4},{"x":3,"x2":4,"y":-1,"y2":0,"text":1,"opacity":0.2},{"x":4,"x2":5,"y":1,"y2":2,"text":1,"opacity":0.2},{"x":1,"x2":2,"y":-1,"y2":0,"text":1,"opacity":0.2},{"x":0,"x2":1,"y":2,"y2":3,"text":1,"opacity":0.2},{"x":2,"x2":3,"y":0,"y2":1,"text":2,"opacity":0.4},{"x":3,"x2":4,"y":1,"y2":2,"text":1,"opacity":0.2},{"x":2,"x2":3,"y":1,"y2":2,"text":3,"opacity":0.6000000000000001},{"x":1,"x2":2,"y":2,"y2":3,"text":1,"opacity":0.2},{"x":3,"x2":4,"y":2,"y2":3,"text":1,"opacity":0.2},{"x":0,"x2":1,"y":1,"y2":2,"text":1,"opacity":0.2},{"x":4,"x2":5,"y":0,"y2":1,"text":1,"opacity":0.2}]}],"marks":[{"type":"rect","from":{"data":"898f21dd-a942-4854-98ba-a6176be537ae"},"properties":{"enter":{"x":{"scale":"x","field":"data.x"},"x2":{"scale":"x","field":"data.x2"},"y":{"scale":"y","field":"data.y"},"y2":{"scale":"y","field":"data.y2"},"fill":{"value":"red"},"fillOpacity":{"field":"data.opacity"}}}},{"type":"text","from":{"data":"898f21dd-a942-4854-98ba-a6176be537ae"},"properties":{"enter":{"y":{"scale":"y","field":"data.y"},"baseline":{"value":"middle"},"align":{"value":"center"},"fill":{"value":"black"},"width":{"value":29},"dy":{"value":15},"x":{"scale":"x","field":"data.x","offset":15},"fontSize":{"value":18.0},"text":{"field":"data.text"}}}},{"type":"rect","from":{"data":"4b5dc34a-cf5f-491c-bd9b-3583af09856c"},"properties":{"enter":{"x":{"scale":"x","field":"data.x"},"x2":{"scale":"x","field":"data.x2"},"y":{"scale":"y","field":"data.y"},"y2":{"scale":"y","field":"data.y2"},"fill":{"value":"green"},"fillOpacity":{"field":"data.opacity"}}}},{"type":"text","from":{"data":"4b5dc34a-cf5f-491c-bd9b-3583af09856c"},"properties":{"enter":{"y":{"scale":"y","field":"data.y"},"baseline":{"value":"middle"},"align":{"value":"center"},"fill":{"value":"black"},"width":{"value":29},"dy":{"value":15},"x":{"scale":"x","field":"data.x","offset":15},"fontSize":{"value":18.0},"text":{"field":"data.text"}}}}]},"value":"#gorilla_repl.vega.VegaView{:content {:width 150, :height 120, :padding nil, :scales [{:name \"x\", :range \"width\", :domain [0 5]} {:name \"y\", :range \"height\", :domain [-1 3], :reverse true}], :axes [{:type \"x\", :scale \"x\", :ticks \"nice\", :values (0 1 2 3 4), :grid true, :orient \"top\", :properties {:labels {:x {:scale \"x\", :offset 15}}}} {:type \"y\", :scale \"y\", :ticks \"nice\", :values (-1 0 1 2), :grid true, :properties {:labels {:y {:scale \"y\", :offset 15}}}} {:scale \"y\", :type \"y\", :orient \"right\", :ticks 0} {:scale \"x\", :type \"x\", :orient \"bottom\", :ticks 0} {:scale \"x\", :type \"x\", :orient \"top\", :ticks 0}], :data ({:name \"898f21dd-a942-4854-98ba-a6176be537ae\", :values ({:x 1, :x2 2, :y 1, :y2 2, :text nil, :opacity 1} {:x 2, :x2 3, :y 0, :y2 1, :text nil, :opacity 1} {:x 3, :x2 4, :y 1, :y2 2, :text nil, :opacity 1})} {:name \"4b5dc34a-cf5f-491c-bd9b-3583af09856c\", :values ({:x 2, :x2 3, :y 2, :y2 3, :text 2, :opacity 0.4} {:x 0, :x2 1, :y 0, :y2 1, :text 1, :opacity 0.2} {:x 2, :x2 3, :y -1, :y2 0, :text 1, :opacity 0.2} {:x 1, :x2 2, :y 0, :y2 1, :text 2, :opacity 0.4} {:x 1, :x2 2, :y 1, :y2 2, :text 1, :opacity 0.2} {:x 4, :x2 5, :y 2, :y2 3, :text 1, :opacity 0.2} {:x 3, :x2 4, :y 0, :y2 1, :text 2, :opacity 0.4} {:x 3, :x2 4, :y -1, :y2 0, :text 1, :opacity 0.2} {:x 4, :x2 5, :y 1, :y2 2, :text 1, :opacity 0.2} {:x 1, :x2 2, :y -1, :y2 0, :text 1, :opacity 0.2} {:x 0, :x2 1, :y 2, :y2 3, :text 1, :opacity 0.2} {:x 2, :x2 3, :y 0, :y2 1, :text 2, :opacity 0.4} {:x 3, :x2 4, :y 1, :y2 2, :text 1, :opacity 0.2} {:x 2, :x2 3, :y 1, :y2 2, :text 3, :opacity 0.6000000000000001} {:x 1, :x2 2, :y 2, :y2 3, :text 1, :opacity 0.2} {:x 3, :x2 4, :y 2, :y2 3, :text 1, :opacity 0.2} {:x 0, :x2 1, :y 1, :y2 2, :text 1, :opacity 0.2} {:x 4, :x2 5, :y 0, :y2 1, :text 1, :opacity 0.2})}), :marks ({:type \"rect\", :from {:data \"898f21dd-a942-4854-98ba-a6176be537ae\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :x2 {:scale \"x\", :field \"data.x2\"}, :y {:scale \"y\", :field \"data.y\"}, :y2 {:scale \"y\", :field \"data.y2\"}, :fill {:value \"red\"}, :fillOpacity {:field \"data.opacity\"}}}} {:type \"text\", :from {:data \"898f21dd-a942-4854-98ba-a6176be537ae\"}, :properties {:enter {:y {:scale \"y\", :field \"data.y\"}, :baseline {:value \"middle\"}, :align {:value \"center\"}, :fill {:value \"black\"}, :width {:value 29}, :dy {:value 15}, :x {:scale \"x\", :field \"data.x\", :offset 15}, :fontSize {:value 18.0}, :text {:field \"data.text\"}}}} {:type \"rect\", :from {:data \"4b5dc34a-cf5f-491c-bd9b-3583af09856c\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :x2 {:scale \"x\", :field \"data.x2\"}, :y {:scale \"y\", :field \"data.y\"}, :y2 {:scale \"y\", :field \"data.y2\"}, :fill {:value \"green\"}, :fillOpacity {:field \"data.opacity\"}}}} {:type \"text\", :from {:data \"4b5dc34a-cf5f-491c-bd9b-3583af09856c\"}, :properties {:enter {:y {:scale \"y\", :field \"data.y\"}, :baseline {:value \"middle\"}, :align {:value \"center\"}, :fill {:value \"black\"}, :width {:value 29}, :dy {:value 15}, :x {:scale \"x\", :field \"data.x\", :offset 15}, :fontSize {:value 18.0}, :text {:field \"data.text\"}}}})}}"}
;; <=
